...
import com.redhat.providers.jaxb.resource.CharSetCustomer;
import com.redhat.providers.jaxb.resource.CharSetResource;
...
public class CharSetTest {
    ...
    public void testReceiveJaxbObjectAsItis() throws Exception {
        WebTarget target = client.target(generateURL("/test/string"));
