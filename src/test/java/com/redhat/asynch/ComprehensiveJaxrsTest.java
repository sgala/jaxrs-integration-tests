...
import com.redhat.asynch.resource.JaxrsAsyncServletApp;
import com.redhat.asynch.resource.JaxrsAsyncServletAsyncResponseBlockingQueue;
import com.redhat.asynch.resource.JaxrsAsyncServletJaxrsResource;
import com.redhat.asynch.resource.JaxrsAsyncServletPrintingErrorHandler;
import com.redhat.asynch.resource.JaxrsAsyncServletResource;
import com.redhat.asynch.resource.JaxrsAsyncServletServiceUnavailableExceptionMapper;
import com.redhat.asynch.resource.JaxrsAsyncServletTimeoutHandler;
import com.redhat.asynch.resource.JaxrsAsyncServletXmlData;
...
public class ComprehensiveJaxrsTest
{
   ...
   private static void checktStatus(Response response, Status status) throws Exception
   {
   ...
   private static void checkException(Future<Response> future, Class<? extends Throwable> e) throws Exception
   {
      ...
      Response response = getResponse(future);
      checktStatus(response, Status.NOT_ACCEPTABLE);
