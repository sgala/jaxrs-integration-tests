...
/*    public static ModelNodeResult runCmd(OnlineManagementClient client, String cmd) throws Exception {
    ...
    /**
     * Get resource in aq.test scope for some class.
     * Example: class org.aq.test.MyTest and name "my_resource.txt" returns "src/aq.test/resource/org/aq.test/my_resource.txt"
     */
