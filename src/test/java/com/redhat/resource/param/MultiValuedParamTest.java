...
import com.redhat.resource.param.resource.CookieParamWrapper;
import com.redhat.resource.param.resource.CookieParamWrapperArrayConverter;
import com.redhat.resource.param.resource.DateParamConverter;
import com.redhat.resource.param.resource.MultiValuedCookieParam;
import com.redhat.resource.param.resource.MultiValuedCookieParamConverter;
import com.redhat.resource.param.resource.MultiValuedParam;
import com.redhat.resource.param.resource.MultiValuedParamConverter;
import com.redhat.resource.param.resource.MultiValuedParamConverterProvider;
import com.redhat.resource.param.resource.MultiValuedParamResource;
import com.redhat.resource.param.resource.MultiValuedParamResourceClient;
import com.redhat.resource.param.resource.MultiValuedPathParam;
import com.redhat.resource.param.resource.MultiValuedPathParamConverter;
import com.redhat.resource.param.resource.ParamWrapper;
import com.redhat.resource.param.resource.ParamWrapperArrayConverter;
import com.redhat.resource.param.resource.PathParamWrapper;
import com.redhat.resource.param.resource.PathParamWrapperArrayConverter;
...
public class MultiValuedParamTest {
    ...
    public void testQueryParam() throws Exception {
		...
		try {
			MultiValuedParamResourceClient.QueryParamResourceClient queryParamResourceClient = client.target(generateBaseUrl()).proxy(MultiValuedParamResourceClient.class).queryParam();
    ...
    public void testHeaderParam() throws Exception {
		ResteasyClient client = new ResteasyClientBuilder().build();
		try {
			MultiValuedParamResourceClient.HeaderParamResourceClient headerParamResourceClient = client.target(generateBaseUrl()).proxy(MultiValuedParamResourceClient.class).headerParam();
    ...
    public void testMatrixParam() throws Exception {
		ResteasyClient client = new ResteasyClientBuilder().build();
		try {
			MultiValuedParamResourceClient.MatrixParamResourceClient matrixParamResourceClient = client.target(generateBaseUrl()).proxy(MultiValuedParamResourceClient.class).matrixParam();
    ...
    public void testCookieParam() throws Exception {
		ResteasyClient client = new ResteasyClientBuilder().build();
		try {
			MultiValuedParamResourceClient.CookieParamResourceClient cookieParamResourceClient = client.target(generateBaseUrl()).proxy(MultiValuedParamResourceClient.class).cookieParam();
    ...
    public void testFormParam() throws Exception {
		ResteasyClient client = new ResteasyClientBuilder().build();
		try {
			MultiValuedParamResourceClient.FormParamResourceClient formParamResourceClient = client.target(generateBaseUrl()).proxy(MultiValuedParamResourceClient.class).formParam();
    ...
    public void testPathParam() throws Exception {
		ResteasyClient client = new ResteasyClientBuilder().build();
		try {
			MultiValuedParamResourceClient.PathParamResourceClient pathParamResourceClient = client.target(generateBaseUrl()).proxy(MultiValuedParamResourceClient.class).pathParam();
