...
import com.redhat.resource.param.resource.SerializableWithParametersObject;
import com.redhat.resource.param.resource.SerializableWithParametersResource;
...
public class SerializableWithParametersTest {
    ...
    public void testSerialize() throws Exception {
        Client client = ClientBuilder.newClient().register(org.jboss.resteasy.plugins.providers.SerializableProvider.class);
