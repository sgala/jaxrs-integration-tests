...
import com.redhat.resource.path.resource.EmailResource;
import com.redhat.resource.path.resource.PathParamCarResource;
import com.redhat.resource.path.resource.PathParamDigits;
import com.redhat.resource.path.resource.PathParamResource;
...
import static com.redhat.utils.TestUtil.*;
...
public class PathParamTest {
    ...
    public static Archive<?> deploy() {
        WebArchive war = prepareArchive(PathLimitedTest.class.getSimpleName());
        return finishContainerPrepare(war, null, PathParamDigits.class, PathParamResource.class,
