...
import com.redhat.core.basic.resources.ApplicationPropertiesConfig;
import com.redhat.core.basic.resources.ApplicationPropertiesConfigResource;
...
public class ApplicationPropertiesConfigTest {
    ...
    public static Archive<?> deploySimpleResource() {
        WebArchive war = TestUtil.prepareArchive(ApplicationPropertiesConfigTest.class.getSimpleName());
        war.addClasses(ApplicationPropertiesConfig.class, ApplicationPropertiesConfigResource.class);
        return TestUtil.finishContainerPrepare(war, null, ApplicationPropertiesConfigResource.class);
    }
